...
def parse_args():
    ...
    parser.add_argument("--gateway-id", default=os.environ.get("VISIONBRIDGE_GATEWAY_ID") or os.environ.get("IOTSUITE_GATEWAY_ID"))
    parser.add_argument("--device-id", default=os.environ.get("VISIONBRIDGE_DEVICE_ID") or os.environ.get("IOTSUITE_DEVICE_ID"))
